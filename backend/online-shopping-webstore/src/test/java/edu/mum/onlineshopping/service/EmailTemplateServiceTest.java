...
// Related objects
	...
	public void testBuild() {
		for(Order order : testOrder) {
			assertTrue(null != emailTemplateService.build(order));
		}
		for(Person p : testPerson) {
			assertTrue(null != emailTemplateService.build(p));
		}
		assertFalse(null != emailTemplateService.build((Order) null));
		assertFalse(null != emailTemplateService.build((Person) null));
	}
